...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="section-padding px-4 sm:px-6 md:px-12 lg:px-20 overflow-hidden noise-bg">
      <div className="max-w-[1600px] mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-5">
            <div className="w-16 h-[3px] bg-primary" />
            <p className="text-base font-bold uppercase tracking-[0.35em] text-primary">
              À Propos
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-display font-black mb-10">
              NOUS SOMMES <span className="text-gradient-gold">MOOVLABS</span>
            </h2>

            <div className="space-y-6 text-lg sm:text-xl lg:text-2xl leading-relaxed text-muted-foreground">
              <p>
                Nous sommes une équipe de <span className="text-foreground font-semibold">designers</span>, 
                <span className="text-foreground font-semibold"> développeurs</span> et 
                <span className="text-foreground font-semibold"> stratèges</span>.
              </p>

              <p>
                Fondés avec une passion pour la <span className="text-primary font-semibold">créativité audacieuse</span>, 
                nous livrons des solutions digitales mesurables.
              </p>
            </div>
            ...
            >
              <div className="absolute -left-4 top-0 bottom-0 w-[5px] bg-primary" />
              <blockquote className="pl-10 text-xl sm:text-2xl md:text-3xl font-display leading-tight">
                "NOUS NE CRÉONS PAS JUSTE DES SITES WEB.
                <br />
                <span className="text-gradient-gold">NOUS FAÇONNONS DES EXPÉRIENCES</span>"
              </blockquote>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            {/* VALUES */}
            <div className="mb-14">
              <h3 className="text-lg sm:text-xl font-bold uppercase tracking-widest mb-8">
                Nos Valeurs
              </h3>
              ...
              <div className="space-y-5">
                {values.map((value, index) => (
                  <motion.div
                    key={value.title}
                    className="border border-foreground/10 rounded-2xl p-6 hover:border-primary transition"
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 w-full max-w-6xl">
            {[
              ...
              { value: "15", label: "Équipe" },
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                className="p-7 border border-foreground/10 rounded-2xl text-center"
                initial={{ opacity: 0, scale: 0.9 }}
                animate={isInView ? { opacity: 1, scale: 1 } : {}}
                transition={{ delay: 1 + index * 0.1 }}
              >
                <span className="block text-4xl sm:text-5xl font-display text-gradient-gold">
                  {stat.value}
                </span>
